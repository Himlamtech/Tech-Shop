"""
Django settings for review service.
"""
...
SERVICE_NAME = os.environ.get("SERVICE_NAME", "review-service")
...
DATABASE_URL = os.environ.get(
    "DATABASE_URL", "postgres://techshop:techshop@localhost:5432/review_db"
)
