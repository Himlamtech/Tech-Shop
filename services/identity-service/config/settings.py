"""
Django settings for identity service.
"""
...
DATABASE_URL = os.environ.get(
    "DATABASE_URL", "mysql://techshop:techshop@localhost:3306/identity_db"
)
...
JWT_PRIVATE_KEY_PATH = os.environ.get("JWT_PRIVATE_KEY", "/app/keys/jwt_private.pem")
